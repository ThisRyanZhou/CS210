...
class testCarData
{
	public static void main(String[] args)
	{
		...
		// get the list of cars that is stored as an HashMap and print it out
		...
		java.util.PriorityQueue carsByTotalRange = manageCarData.getCarListByTotalRange();
		while( carsByTotalRange.size() > 0 )
		{
			System.out.println(carsByTotalRange.poll());
		}
		System.out.println(); 

		// poll out the elements of the PriorityQueue ordered by remaining range 
		System.out.println("carListByRemainingRange poll");
		java.util.PriorityQueue carsByRemaingRange = manageCarData.getCarListByRemainingRange();
		while( carsByRemaingRange.size() > 0 )
		{
			System.out.println(carsByRemaingRange.poll());
		}
		System.out.println(); 
