...
public class zhou_program8 {
    private static int[] sortData = null;
    private static int[] searchData = null;
    private static JFrame frame;
    private static JLabel[] leftLabels;
    private static JLabel[] rightLabels;
    
    // Data structures for sorting/adding
    ...
    // Flags to track which sort/add buttons have been clicked
    private static boolean selectionSortDone = false;
    private static boolean bstDone = false;
    ...
    private static JButton bstSearchBtn;
    ...
    public static void main(String[] args) {
        if (args.length < 2) {
            System.out.println("Usage: java zhou_p8 <sort_file> <search_file>");
            System.exit(1);
        }
        ...
        // Set border colors: main border red, smaller borders black, yellow, and blue (rotated)
        Color leftBorderColor = Color.YELLOW;
        Color rightBorderColor = Color.BLUE;
        Color mainBorderColor = Color.RED;
        Color buttonPanelBorderColor = Color.BLACK;
        ...
        // Left Panel - Sort/Add buttons (matching chen_p8 GUI structure)
        JPanel leftPanel = new JPanel();
        GridBagLayout leftGrid = new GridBagLayout();
        leftPanel.setBorder(BorderFactory.createLineBorder(leftBorderColor, 8));
        ...
        JButton[] leftButtons = {selectionSortBtn, bstBtn, treeSetBtn, priorityQueueBtn, 
                                 hashSetBtn, arrayListBtn, arrayListSortedBtn, intArrayBtn, 
                                 mergeSortBtn, merge2SortBtn, quickSortBtn};
        ...
        bstBtn.addActionListener(new ButtonActionListener("BST"));
        ...
        // Add buttons and labels to left panel
        ...
        // Right Panel - Search buttons (matching chen_p8 GUI structure)
        JPanel rightPanel = new JPanel();
        GridBagLayout rightGrid = new GridBagLayout();
        rightPanel.setBorder(BorderFactory.createLineBorder(rightBorderColor, 8));
        ...
        bstSearchBtn = new JButton("search bst");
        ...
        JButton[] rightButtons = {binarySearchSortedBtn, bstSearchBtn, treeSetSearchBtn, priorityQueueSearchBtn,
                                 hashSetSearchBtn, arrayListSearchBtn, arrayListBinarySearchBtn, intArraySearchBtn, 
                                 mergeSortedBinarySearchBtn, merge2SortedBinarySearchBtn, quickSortedBinarySearchBtn};
        rightLabels = new JLabel[12];
        
        // Initially disable all search buttons
        for (JButton btn : rightButtons) {
            btn.setEnabled(false);
        }
        
        binarySearchSortedBtn.addActionListener(new ButtonActionListener("BinarySearchSorted"));
        bstSearchBtn.addActionListener(new ButtonActionListener("BSTSearch"));
        ...
        // Main layout - matching chen_p8 structure
        JPanel mainButtonPanel = new JPanel();
        BoxLayout mainGrid = new BoxLayout(mainButtonPanel, BoxLayout.X_AXIS);
        mainButtonPanel.setBorder(BorderFactory.createLineBorder(buttonPanelBorderColor, 8));
        ...
        mainPanel.setBorder(BorderFactory.createLineBorder(mainBorderColor, 8));
    ...
    private static void readSortFile(String fileName) {
        try {
            ...
            // Enable sort/add buttons
            selectionSortBtn.setEnabled(true);
            bstBtn.setEnabled(true);
            ...
            // Enable search buttons if search file was already loaded
    ...
    private static void readSearchFile(String fileName) {
        try {
            ...
            // Enable search buttons if corresponding sort/add button was clicked
            enableSearchButtonsIfReady();
    ...
    private static void performBinarySearchSorted() {
        if (searchData == null || sortedIntArray == null) return;
    ...
    private static void performBSTSearch() {
        if (searchData == null || bst == null) return;
    ...
    private static void performTreeSetSearch() {
        if (searchData == null || treeSet == null) return;
    ...
    private static void performPriorityQueueSearch() {
        if (searchData == null || priorityQueue == null) return;
    ...
    private static void performHashSetSearch() {
        if (searchData == null || hashSet == null) return;
    ...
    private static void performArrayListSearch() {
        if (searchData == null || arrayList == null) return;
    ...
    private static void performArrayListBinarySearch() {
        if (searchData == null || arrayListSorted == null) return;
    ...
    private static void performMergeSortedBinarySearch() {
        if (searchData == null || mergeSortedArray == null) return;
    ...
    private static void performMerge2SortedBinarySearch() {
        if (searchData == null || merge2SortedArray == null) return;
    ...
    private static void performQuickSortedBinarySearch() {
        if (searchData == null || quickSortedArray == null) return;
