public class zhou_BinarySearchTree implements BinarySearchTreeFunctions
{
	private Node root;
	
	public zhou_BinarySearchTree()
	{
		root = null;
	}
	...
	public int getHeight(Node x)
	{
		...
		int left = getHeight(x.getLeft());
		int right = getHeight(x.getRight());
