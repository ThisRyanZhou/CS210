class ByteBufferSampleCode
{
	...
	// again retrieved from a copy of the byte array (wants to simulate saving the 
	...
	public static void main(String[] args)
	{
		...
		// print out the two values, this is mainly in case the double can't be represented correctly
